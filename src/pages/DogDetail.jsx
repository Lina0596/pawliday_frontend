...
export default function DogDetail() {
  ...
  if (dataLoading || !owners || !dogs || !dog || !dogOwner)
    return <LoadingSpinner />;

  return (
    <div>
      {(locationStatus?.action === "add dog" ||
        locationStatus?.action === "update dog") &&
      locationStatus?.type === "success" ? (
        <SuccessMessage>{locationStatus.message}</SuccessMessage>
      ) : null}
